...
#数码管对应的引脚
set_location_assignment	PIN_M8	-to Y[0]
set_location_assignment	PIN_L7	-to Y[1]
set_location_assignment	PIN_P9	-to Y[2]
set_location_assignment	PIN_N9	-to Y[3]
set_location_assignment	PIN_M9	-to Y[4]
set_location_assignment	PIN_M10	-to Y[5]
set_location_assignment	PIN_P11	-to Y[6]
set_location_assignment	PIN_N11	-to Y[7]
set_location_assignment	PIN_N6	-to VSYNC
set_location_assignment	PIN_P6	-to PCLK
set_location_assignment	PIN_M6  -to HREF
