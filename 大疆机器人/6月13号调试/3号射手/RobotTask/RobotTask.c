...
{
   SpeedNowOne = GetEncoder.V3; SpeedTagOne = Speed;   //无量纲
   ...
   MotorSpeedSetOne(SpeedControlOne);                 //放入PWM，用于收敛速度的控制中
}

void PidSpeedControlTwo(s32 Speed)
{
   SpeedNowTwo = GetEncoder.V5; SpeedTagTwo = Speed;   //无量纲
   ...
   MotorSpeedSetTwo(SpeedControlTwo);                 //放入PWM，用于收敛速度的控制中
}
